...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    var embeds = [
      new MessageEmbed()
      .setColor("#A3C7FD")
      .setImage("https://cdn.discordapp.com/attachments/921593993664557116/923284790654926928/HYPEABIS_FENDER_BANNER.png"),
      new MessageEmbed()
      .setColor("#A3C7FD")
      // .setFooter(es.footertext, message.guild.iconURL({
      //   dynamic: true
      // }))
      .setImage("https://cdn.discordapp.com/attachments/921593993664557116/923282668567805982/HYPEABIS_FENDER_BACKGROUND.png")
