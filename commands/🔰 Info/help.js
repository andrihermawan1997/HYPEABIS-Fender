...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    if (args[0]) {
      ...
      let button_back = new MessageButton().setStyle('PRIMARY').setCustomId('1').setEmoji("833802907509719130").setLabel(handlemsg(client.la[ls].cmds.info.help.buttons.back))
      ...
      let button_forward = new MessageButton().setStyle('PRIMARY').setCustomId('3').setEmoji('832598861813776394').setLabel(handlemsg(client.la[ls].cmds.info.help.buttons.forward))
      let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("914453535071035422").setLabel("Support").setURL("https://discord.gg/kyGRVPh4xs")
      let menuOptions = [{
          label: "Overview",
          value: "Overview",
          emoji: "914453535071035422",
      ...
      let OverviewEmbed = new MessageEmbed()
        .setColor("#2B7BF2").setThumbnail(es.thumb ? es.footericon : null)
...
<a:adev:847720420140515338> Support [**Premier Crafty**](https://discord.gg/kyGRVPh4xs)`)
        .setImage('https://media.discordapp.net/attachments/890487988700741682/921424738734178324/Vinyl_Banner.png?width=1025&height=334')
