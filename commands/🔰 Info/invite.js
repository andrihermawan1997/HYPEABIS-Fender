    ...
    if (user) {
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter(`${user.username} | powered by Premier Crafty`, "https://cdn.discordapp.com/attachments/921074297399836723/921399472645345280/Vinyl_Profile_Picture.png")
        ],
